...
repr = "(member desc (member query (parameter req *)))" and t = "src" and result = 1.0000000000  or 
...
repr = "(member desc *)" and t = "src" and result = 1.0000000000  or 
repr = "(member userid (member query (parameter req *)))" and t = "src" and result = 1.0000000000  or 
repr = "(member desc (member query *))" and t = "src" and result = 1.0000000000
}}